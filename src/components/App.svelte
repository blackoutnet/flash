  ...
  <main class="p-12 md:p-16 lg:p-20 xl:p-24 w-screen max-w-none lg:max-w-prose lg:w-auto h-auto lg:h-screen lg:overflow-y-auto prose dark:prose-invert prose-green bg-white dark:bg-gray-900">
    <section>
      ...
      <p>
        ...
        your <a href="https://comma.ai/shop/comma-3x" target="_blank">comma3/3X</a>.
      </p>
    </section>
    <hr />
    <section>
    ...
    <section>
      ...
      {#if isLinux}
        ...
        <div class="relative text-sm">
          ...
          <button class="absolute top-2 right-2 bg-blue-600 hover:bg-blue-500 active:bg-blue-300 transition-colors text-white p-1 rounded-md" on:click={() => copy(DETACH_SCRIPT)}>Copy</button>
        </div>
      {/if}
      <p>
        Next, click the button to start flashing. From the prompt select the device which starts with &ldquo;QUSB_BULK&rdquo;.
      </p>
      <p>
    ...
    <section>
      ...
      <p>
        This is normal in QDL mode. You can verify that the &ldquo;QUSB_BULK&rdquo; device shows up when you press the Flash button to know that it is working correctly.
      </p>
      ...
      <p>
        If you need help, join our <a href="https://discord.comma.ai" target="_blank">Discord server</a> and go to the <strong>#hw-three-3x</strong> channel.
      </p>
    </section>
